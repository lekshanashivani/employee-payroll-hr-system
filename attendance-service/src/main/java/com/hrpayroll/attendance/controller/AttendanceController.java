...
public class AttendanceController {
    ...
    public ResponseEntity<Attendance> markAttendance(
        ...
        try {
            Attendance attendance = attendanceService.markAttendance(employeeId, date);
    ...
    public ResponseEntity<LeaveRequest> rejectLeaveRequest(
        ...
        try {
            LeaveRequest rejected = leaveService.rejectLeaveRequest(id, rejectionReason, rejectedByUserId, rejectedByRole);
